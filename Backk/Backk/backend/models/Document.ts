...
export interface IDocument extends Document {
  ...
  title: string;
  content: string;
  /** Document category - extended to include hotel-specific types */
  category:
    | "hotel"
    | "restaurant"
    | "menu"
  ...
  email?: string;
  website?: string;
  rating?: number; // e.g., aggregated rating 0-5
 ...
 */
// include hotel-specific fields in text index for better search
...
const DocumentModel: IDocumentModel = mongoose.model<IDocument, IDocumentModel>(
  "Document",
  documentSchema,
);
